                    ...
                    <section>
                        ...
                        <label class="select margin-bottom-5">
                            {{ Form::select('make_slug_from_name', array(
                                ...
                                '1' => 'Транслит + нижний регистр, Всегда (даже если поле скрыто или передано непустое значение)',
                                '2' => 'Транслит + нижний регистр, Поле не скрыто, передано пустое значение',
                                '3' => 'Транслит + нижний регистр, Поле скрыто, в БД пустое значение (только 1 раз)',

                                '4' => 'Транслит + сохранять верхний регистр, Всегда (даже если поле скрыто или передано непустое значение)',
                                '5' => 'Транслит + сохранять верхний регистр, Поле не скрыто, передано пустое значение',
                                '6' => 'Транслит + сохранять верхний регистр, Поле скрыто, в БД пустое значение (только 1 раз)',

                                '7' => 'Без транслита, Всегда (даже если поле скрыто или передано непустое значение)',
                                '8' => 'Без транслита, Поле не скрыто, передано пустое значение',
                                '9' => 'Без транслита, Поле скрыто, в БД пустое значение (только 1 раз)',
                            )) }}
                        </label>
