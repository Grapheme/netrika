...
@section('scripts')
    ...
    @if (1)
    <!-- ACE minify -->
    {{ HTML::script('admin/js/ace-builds/src-min-noconflict/ace.js') }}
    <script>
    ...
    @if (0)
    <!-- ACE full -->
    {{ HTML::script('admin/js/ace/demo/kitchen-sink/require.js') }}
    <script>
        // setup paths
        require.config({paths: { "ace" : "{{ asset('admin/js/ace/lib/ace') }}" } });
