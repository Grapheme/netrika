...
return array(
    ...
    'actions' => function($dic, $dicval) {
        ...
        $dic_documents = $dics['normative-documents'];
        $counts = Config::get('temp.index_counts');
        return '
            <span class="block_ margin-bottom-5_">
                <a href="' . URL::route('entity.index', array('normative-documents', 'filter[fields][solution_id]' => $dicval->id)) . '" class="btn btn-default">
