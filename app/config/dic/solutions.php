...
JS
     ...
     */
    'slug_note' => <<<HTML
        <p>Только символы англ. алфавита, знаки _ и -, цифры</p>
        <br/>
        <p><b>Предустановленные стили:</b></p>
        <p>Здравоохранение - health</p>
        <p>Образование - education</p>
        <p>Открытое правительство - goverment</p>
        <p>Туризм - tourism</p>
        <p>Суды - law</p>
        <p>Порталы - portals</p>
HTML
