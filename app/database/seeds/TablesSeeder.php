...
class TablesSeeder extends Seeder{
	...
	public function run(){
        ...
        Dictionary::create(array('slug'=>'project-categories','name'=>'Категории проектов','entity'=> 1,'icon_class'=>'fa-sitemap','hide_slug'=>1,'make_slug_from_name'=>1,'name_title'=>'Название категории','pagination'=>0,'view_access'=>1,'sort_by'=>NULL,'sort_order_reverse'=>0,'sortable'=>1,'order'=>0));
