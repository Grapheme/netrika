...
class TablesSeeder extends Seeder{
	...
	public function run(){
        ...
        Dictionary::create(array('slug'=>'entities_tags','name'=>'Теги','entity'=> 0,'icon_class'=>'fa-tags','hide_slug'=>1,'make_slug_from_name'=>1,'name_title'=>'Название тега','pagination'=>0,'view_access'=>1,'sort_by'=>NULL,'sort_order_reverse'=>0,'sortable'=>1,'order'=>0));
