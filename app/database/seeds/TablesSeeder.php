...
class TablesSeeder extends Seeder{
	...
	public function run(){
        ...
        Dictionary::create(array('slug'=>'entities-tags','name'=>'Теги','entity'=> 1,'icon_class'=>'fa-tags','hide_slug'=>1,'make_slug_from_name'=>1,'name_title'=>'Название тега','pagination'=>0,'view_access'=>1,'sort_by'=>NULL,'sort_order_reverse'=>0,'sortable'=>1,'order'=>0));

        Dictionary::create(array('slug'=>'solution-documents','name'=>'Норматив. документы (Решения)','entity'=> 0,'icon_class'=>'fa-file-text','hide_slug'=>1,'make_slug_from_name'=>1,'name_title'=>'Название документа','pagination'=>0,'view_access'=>2,'sort_by'=>NULL,'sort_order_reverse'=>0,'sortable'=>1,'order'=>0));
        Dictionary::create(array('slug'=>'project-documents','name'=>'Норматив. документы (Проекты)','entity'=> 0,'icon_class'=>'fa-file-text','hide_slug'=>1,'make_slug_from_name'=>1,'name_title'=>'Название документа','pagination'=>0,'view_access'=>2,'sort_by'=>NULL,'sort_order_reverse'=>0,'sortable'=>1,'order'=>0));

        Dictionary::create(array('slug'=>'clients-institutions','name'=>'Учреждения','entity'=> 0,'icon_class'=>'fa-building','hide_slug'=>1,'make_slug_from_name'=>1,'name_title'=>'Название учреждения','pagination'=>0,'view_access'=>2,'sort_by'=>NULL,'sort_order_reverse'=>0,'sortable'=>1,'order'=>0));
	}
}